...
def millepede(
        input_file : List[str],
        survey_constraints : bool = typer.Option(False,help='apply constraints from survey'),
        beamspot_constraints : bool = typer.Option(False,help='apply beam spot constraints'),
        minimization : str = typer.Option('steering/steer_minimization_template.txt',
            help='files holding the minimization settings for pede'),
        constraint_file : str = typer.Option(None,help='optional external constraint file for pede')
        ) :
    """
